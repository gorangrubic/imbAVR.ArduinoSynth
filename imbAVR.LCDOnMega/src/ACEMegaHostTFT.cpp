...
//size_t ACEMegaHostTFTClass::write(uint8_t c) {
//
//	if (c == '\n') {
//		cursor_y += textsize * 8;
//		cursor_x = leftTab;
...
void ACEMegaHostTFTClass::setLeftTab(uint16_t _leftTab) {
	leftTab = _leftTab;
}
...
ACEMegaHostTFTClass::ACEMegaHostTFTClass() : Adafruit_GFX(TFTWIDTH, TFTHEIGHT) {
...
void ACEMegaHostTFTClass::init(void) {
...
void ACEMegaHostTFTClass::begin(uint16_t id) {
	uint8_t i = 0;
...
void ACEMegaHostTFTClass::reset(void) {
...
void ACEMegaHostTFTClass::setAddrWindow(int x1, int y1, int x2, int y2) {
...
void ACEMegaHostTFTClass::setLR(void) {
	CS_ACTIVE;
...
void ACEMegaHostTFTClass::flood(uint16_t color, uint32_t len) {
	uint16_t blocks;
...
void ACEMegaHostTFTClass::drawFastHLine(int16_t x, int16_t y, int16_t length,
	uint16_t color)
{
	int16_t x2;
...
void ACEMegaHostTFTClass::drawFastVLine(int16_t x, int16_t y, int16_t length,
	uint16_t color)
{
	int16_t y2;
...
void ACEMegaHostTFTClass::fillRect(int16_t x1, int16_t y1, int16_t w, int16_t h,
	uint16_t fillcolor) {
	int16_t  x2, y2;
...
void ACEMegaHostTFTClass::fillScreen(uint16_t color) {
...
void ACEMegaHostTFTClass::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
void ACEMegaHostTFTClass::pushColors(uint16_t *data, uint8_t len, boolean first) {
	uint16_t color;
	uint8_t  hi, lo;
	CS_ACTIVE;
...
void ACEMegaHostTFTClass::setRotation(uint8_t x) {
...
uint16_t ACEMegaHostTFTClass::readPixel(int16_t x, int16_t y) {
...
uint16_t ACEMegaHostTFTClass::readID(void) {
...
uint16_t ACEMegaHostTFTClass::color565(uint8_t r, uint8_t g, uint8_t b) {
	// 0xF8 => 248
	// 0XFC => 252
...
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
void ACEMegaHostTFTClass::writeA16B3(uint16_t address, uint8_t ub, uint8_t mb, uint8_t lb) {
	uint8_t hi, lo;
	CS_ACTIVE;
...
void ACEMegaHostTFTClass::drawLine3Byte(int16_t x0, int16_t y0,
...
void ACEMegaHostTFTClass::drawPixel3(int16_t x, int16_t y, uint8_t r, uint8_t g, uint8_t b)
{
	if ((x < 0) || (y < 0) || (x >= _width) || (y >= _height)) return;
...
#ifndef write8
void ACEMegaHostTFTClass::write8(uint8_t value) {
	write8inline(value);
}
#endif

#ifdef read8isFunctionalized
uint8_t ACEMegaHostTFTClass::read8fn(void) {
	uint8_t result;
	read8inline(result);
	return result;
}
...
//#ifdef read8isFunctionalized
//uint8_tACEMegaHostTFTClass::read8fn(void) {
//	uint8_t result;
//	read8inline(result);
//	return result;
//}
...
#ifndef setWriteDir
void ACEMegaHostTFTClass::setWriteDir(void) {
	setWriteDirInline();
}
#endif

#ifndef setReadDir
void ACEMegaHostTFTClass::setReadDir(void) {
	setReadDirInline();
}
#endif

#ifndef writeRegister8
void ACEMegaHostTFTClass::writeRegister8(uint8_t a, uint8_t d) {
	writeRegister8inline(a, d);
}
#endif

#ifndef writeRegister16
void ACEMegaHostTFTClass::writeRegister16(uint16_t a, uint16_t d) {
	writeRegister16inline(a, d);
}
#endif

#ifndef writeRegisterPair
void ACEMegaHostTFTClass::writeRegisterPair(uint8_t aH, uint8_t aL, uint16_t d) {
