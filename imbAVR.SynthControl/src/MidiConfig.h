...
#define CC_PERK_AmpATime 26
#define CC_PERK_AmpBTime 10
#define CC_PERK_AmpALevel 18
#define CC_PERK_AmpBLevel 1

#define CC_PERK_PitchATime 27
#define CC_PERK_PitchBTime 11
