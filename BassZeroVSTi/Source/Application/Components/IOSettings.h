...
public:
	...
	dataIntProperty IOUpdateCycle = dataIntProperty("IOUpdateCycle", 10, "MIDI IO update cycle", "Period for input/output update", "ms");
	...
	dataIntProperty FullSyncPlayTimeout = dataIntProperty("FullSyncPlayTimeout", 100, "Full sync timeout", "Time to wait after Play (at DAW or MIDI generator) is off - before syncing all preset parameters to synth", "ms");
	...
	dataIntProperty DeviceConnectRetry = dataIntProperty("DeviceConnectRetry", 2, "Device connect retry", "Time to retry connection with the device", "ms");
