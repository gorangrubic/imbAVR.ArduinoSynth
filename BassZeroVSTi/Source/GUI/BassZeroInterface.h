...
#include "Components/ControlStateDisplay.h"
#include "Components/SynthStateDisplay.h"
...
private:
    ...
    std::unique_ptr<Component> controlStateDisplay;
    std::unique_ptr<Component> synthStatusDisplay;
