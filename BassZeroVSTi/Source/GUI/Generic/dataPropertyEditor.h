/*
  ==============================================================================
    ...
    dataPropertyEditor.h
    Created: 27 Oct 2019 2:46:32am
    Author:  gorangrubic
...
/*
*/
class dataPropertyEditor    : public Component
{
public:
    dataPropertyEditor()
    {
    ...
    void paint (Graphics& g) override
    {
        ...
        */
        ...
        g.setFont (14.0f);
        g.drawText ("dataPropertyEditor", getLocalBounds(),
...
private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (dataPropertyEditor)
};
