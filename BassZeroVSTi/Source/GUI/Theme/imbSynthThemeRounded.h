...
*/
struct imbSynthLookAndFeel    : public LookAndFeel_V4
{
	static void setupCustomLookAndFeelColours(LookAndFeel& laf)
	{
	...
	static void setupSquareLookAndFeelColours(LookAndFeel& laf)
	{
