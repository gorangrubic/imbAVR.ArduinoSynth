...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class OSCBasicEditor  : public Component,
                        public imbSynthGUIComponent
{
public:
    //==============================================================================
    OSCBasicEditor (imbSynthStateData * synthState, String nameSufix);
    ~OSCBasicEditor();
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OSCBasicEditor)
};
