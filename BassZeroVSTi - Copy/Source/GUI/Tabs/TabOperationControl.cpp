...
//==============================================================================
TabOperationControl::TabOperationControl (imbSynthStateData * synthState, String nameSufix)
{
    ...
    labelMODA->setBounds (512, 8, 160, 18);
    ...
    labelMODA3->setBounds (512, 174, 160, 18);
    ...
    LabelVALC->setBounds (512, 268, 324, 18);
...
void TabOperationControl::resized()
{
    ...
    modA1->setBounds (512, 8 + 18, 160, 76);
    modB1->setBounds (512 + 160 - -4, 8 + 18, 160, 76);
    valC1->setBounds (512, 268 + 18, 160, 76);
    valC2->setBounds (676, 268 + 18, 160, 76);
    modA2->setBounds (512, (8 + 18) + 76 - 4, 160, 76);
    labelMODB->setBounds (512 + 160 - -4, 8, 160, 18);
    modB2->setBounds ((512 + 160 - -4) + 0, (8 + 18) + 76 - 4, 160, 76);
    labelMODA4->setBounds (512 + 160 - -4, 174, 160, 18);
    valA1->setBounds (512, 174 + 18, 160, 76);
    valB1->setBounds (676, (174 + 18) + 0, 160, 76);
...
<JUCER_COMPONENT documentType="Component" className="TabOperationControl" componentName=""
  ...
  <JUCERCOMP name="" id="1474ddf3224b6bf5" memberName="modA1" virtualName=""
             explicitFocusOrder="0" pos="512 0R 160 76" posRelativeY="995d370610ffd3e1"
  ...
  <JUCERCOMP name="" id="cc6b5c20302ca164" memberName="valC1" virtualName=""
             explicitFocusOrder="0" pos="512 0R 160 76" posRelativeY="ceaeec3d2ebe5aa6"
             sourceFile="Components/OPMToSignalChangeEditor.cpp" constructorParams=""/>
  <JUCERCOMP name="" id="3cd1decada909c47" memberName="valC2" virtualName=""
             explicitFocusOrder="0" pos="676 0R 160 76" posRelativeY="ceaeec3d2ebe5aa6"
             sourceFile="Components/OPMToSignalChangeEditor.cpp" constructorParams=""/>
  <LABEL name="new label" id="995d370610ffd3e1" memberName="labelMODA"
         virtualName="" explicitFocusOrder="0" pos="512 8 160 18" posRelativeX="6f9f204dacc67317"
  ...
  <JUCERCOMP name="" id="11a6440739bbbbb7" memberName="modA2" virtualName=""
             explicitFocusOrder="0" pos="512 4R 160 76" posRelativeY="1474ddf3224b6bf5"
             sourceFile="Components/OPMToSignalChangeEditor.cpp" constructorParams=""/>
  <LABEL name="new label" id="d5b6addb2e4190e6" memberName="labelMODB"
         virtualName="" explicitFocusOrder="0" pos="-4R 8 160 18" posRelativeX="995d370610ffd3e1"
         posRelativeY="6f9f204dacc67317" bkgCol="fff0ffff" textCol="ff181f22"
  ...
  <LABEL name="new label" id="17686cde2f9a7ac4" memberName="labelMODA3"
         virtualName="" explicitFocusOrder="0" pos="512 174 160 18" posRelativeX="6f9f204dacc67317"
         posRelativeY="6f9f204dacc67317" bkgCol="fff0ffff" textCol="ff181f22"
  ...
  <LABEL name="new label" id="345a4deecb86f004" memberName="labelMODA4"
         virtualName="" explicitFocusOrder="0" pos="-4R 174 160 18" posRelativeX="995d370610ffd3e1"
         posRelativeY="6f9f204dacc67317" bkgCol="fff0ffff" textCol="ff181f22"
  ...
  <JUCERCOMP name="" id="10d33e3002129c6" memberName="valA1" virtualName=""
             explicitFocusOrder="0" pos="512 0R 160 76" posRelativeY="17686cde2f9a7ac4"
             sourceFile="Components/OPMToSignalChangeEditor.cpp" constructorParams=""/>
  <JUCERCOMP name="" id="ac05be0a6548b1d4" memberName="valB1" virtualName=""
             explicitFocusOrder="0" pos="676 0 160 76" posRelativeY="10d33e3002129c6"
             sourceFile="Components/OPMToSignalChangeEditor.cpp" constructorParams=""/>
  <LABEL name="new label" id="ceaeec3d2ebe5aa6" memberName="LabelVALC"
         virtualName="" explicitFocusOrder="0" pos="512 268 324 18" posRelativeX="6f9f204dacc67317"
         posRelativeY="6f9f204dacc67317" bkgCol="fff0ffff" textCol="ff181f22"
