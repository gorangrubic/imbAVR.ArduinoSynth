...
<JUCER_COMPONENT documentType="Component" className="MainViewTabPresetManager"
  ...
  <JUCERCOMP name="" id="4a47e8e5c4db0633" memberName="presetLibraryView"
             virtualName="" explicitFocusOrder="0" pos="0 0 440 4M" sourceFile="PresetFileBrowser.cpp"
             constructorParams=""/>
  <JUCERCOMP name="" id="b0a6f0fa687bc200" memberName="presetDefinitionDisplay"
             virtualName="" explicitFocusOrder="0" pos="440 8 448M 40M" sourceFile="PresetDefinitionEditor.cpp"
             constructorParams=""/>
</JUCER_COMPONENT>
