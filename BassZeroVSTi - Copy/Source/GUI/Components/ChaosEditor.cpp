...
ChaosEditor::ChaosEditor (imbSynthStateData * synthState, String nameSufix)
{
    ...
    Value->setTextBoxStyle (Slider::NoTextBox, true, 50, 20);
    ...
    label4->setColour (Label::backgroundColourId, Colour (0x00181f22));
    label4->setColour (Label::textColourId, Colour (0x75f0ffff));
    label4->setColour (TextEditor::textColourId, Colours::black);
    label4->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    label4->setBounds (24, 80, 63, 14);
    ...
    toggle_retrigger->setBounds (176, 24, 63, 16);
    ...
    toggle_loop->setBounds (176, 48, 63, 16);
...
void ChaosEditor::resized()
{
    ...
    Value->setBounds (86 - 62, 16, 62, 62);
...
<JUCER_COMPONENT documentType="Component" className="ChaosEditor" componentName=""
  ...
  <SLIDER name="DirectValue" id="9258fb4fcb5b6574" memberName="Value" virtualName=""
          explicitFocusOrder="0" pos="86r 16 62 62" tooltip="Decay time&#10;"
          thumbcol="ffed6216" min="1.0" max="127.0" int="1.0" style="RotaryHorizontalVerticalDrag"
  ...
  <COMBOBOX name="new combo box" id="62baf5ef154366df" memberName="Curve"
            virtualName="" explicitFocusOrder="0" pos="88 80 148 16" editable="0"
            layout="33" items="Triangle&#10;Ramp Down&#10;Ramp Up&#10;Square Pulse&#10;Sinewave&#10;Chaos"
            textWhenNonSelected="Triangle" textWhenNoItems="(no choices)"/>
  <LABEL name="new label" id="11b76944d532524a" memberName="label4" virtualName=""
         explicitFocusOrder="0" pos="24 80 63 14" bkgCol="181f22" textCol="75f0ffff"
         edTextCol="ff000000" edBkgCol="0" labelText="Function" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
  ...
  <TOGGLEBUTTON name="new toggle button" id="2cfe8a56cb12fe68" memberName="toggle_retrigger"
                virtualName="" explicitFocusOrder="0" pos="176 24 63 16" buttonText="Re-trig."
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="1"/>
  <TOGGLEBUTTON name="new toggle button" id="eb3f284f0415ad84" memberName="toggle_loop"
                virtualName="" explicitFocusOrder="0" pos="176 48 63 16" buttonText="Loop"
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="1"/>
  <LABEL name="new label" id="f9922551998c59e2" memberName="label3" virtualName=""
         explicitFocusOrder="0" pos="81 4 86 16" edTextCol="ff000000"
  ...
  <LABEL name="new label" id="37e4a23ecadc0cc9" memberName="label5" virtualName=""
         explicitFocusOrder="0" pos="81 38 86 16" edTextCol="ff000000"
  ...
  <SLIDER name="new slider" id="da120fb852e0c0e8" memberName="Time" virtualName=""
          explicitFocusOrder="0" pos="81 15 86 24" thumbcol="ff397daa"
          min="0.0" max="127.0" int="0.0" style="LinearHorizontal" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1.0"
          needsCallback="1"/>
  <SLIDER name="new slider" id="c401572f19b035c5" memberName="Factor" virtualName=""
          explicitFocusOrder="0" pos="81 51 86 24" thumbcol="ff397daa"
          min="0.0" max="127.0" int="0.0" style="LinearHorizontal" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1.0"
          needsCallback="1"/>
</JUCER_COMPONENT>
